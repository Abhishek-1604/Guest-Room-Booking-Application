...
function JohnHouse() {
  ...
  useEffect(() => {
    try {
      axios.get('http://localhost:5000/app/h3/getall')
        .then((res) => {
          setRoom(res.data);
        });
    } catch (e) {
  ...
  return (
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3915.4009507388173!2d76.99461587452087!3d11.083465653456344!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba8f7495bda0d4b%3A0xb88dc22cdef000a0!2sKgiSL!5e0!3m2!1sen!2sin!4v1710329526960!5m2!1sen!2sin" style={{width:"100%",height:"400px"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</div>

<div className='container-fluid row'>
          <h1 style={{ textAlign: "center", color: "green" }}>Facilities of John House </h1>
          <div className="row">
